...
struct ConvexNode
{
    ...
    bool is_appr_min_dist_from_q_larger_by_hyper_plane( Vector<T>& query_point, FLOAT_TYPE dist_compare, int *scalar_product_num){
        /*
    ...
    void print(){
		std::cout << "----------------------------------------------------" << endl;
        std::cout << "isLeaf:" << isLeaf << endl;
		std::cout << "node index:" << index << endl;
		std::cout << "leaf index:" << leaf_index << endl;
        std::cout << "parent index:"<< parent_index << endl;
        std::cout << "left index:"<< left <<", " << endl;
		std::cout << "right index:" << right << endl;
